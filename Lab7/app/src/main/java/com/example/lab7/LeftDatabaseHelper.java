...
public class LeftDatabaseHelper extends SQLiteOpenHelper {
    private SQLiteDatabase db;
    public static final String DATABASE_NAME = "Left.db";
    public static final String TABLE_NAME = "Left_table";
    public static final String COL_1 = "NAME";
    public static final String COL_2 = "DEPT";
    public static final String COL_3 = "YEAR";

    public LeftDatabaseHelper(Context context) {
